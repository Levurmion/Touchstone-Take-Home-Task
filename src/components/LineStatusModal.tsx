    ...
    if (selectedLine) {
        ...
        return (
            <section className="fixed flex flex-col items-center justify-center w-full h-full left-0 top-0 bg-black/15 z-50">
                <dialog className="fixed flex flex-col gap-4 w-[90vw] sm:w-[60vw] md:w-[50vw] lg:w-[40vw] rounded-lg shadow-lg h-fit p-6 bg-white">
                    <div className="flex flex-col w-full">
                        <div className="flex flex-row justify-between items-center">
                            <h1 className="w-fit text-2xl sm:text-3xl font-semibold">
                                {name} line
                            </h1>
